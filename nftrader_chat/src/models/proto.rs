...
mod tests {
    ...
    fn test_serialization() {
        let input = Input::Joined(JoinedInput {
            nickname: "vanea".to_string(),
        });
        let serialized =
            serde_json::from_str(r#"{"input": "Joined", "payload": {"nickname": "vanea"}}"#)
                .unwrap();
    ...
    fn test_deserialization() {
        ...
        let output = serde_json::to_string(&Output::Posted(PostedOutput {
            content: "derp".to_string(),
        }))
        .unwrap();
